...
//贷款审核
export const customerManageAudit = (params) => {
	return Http.post('/audit/customerManageAudit',params)
};
//贷款审核
export const auditLoan = (params) => {
	return Http.post('/audit/auditLoan',params)
};

//撤回任务
export const toWithdraw = (params) => {
	return Http.post('/audit/toWithdraw',params)
};
